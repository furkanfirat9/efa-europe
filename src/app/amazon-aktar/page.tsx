      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs space-y-6">
          <div>
            ...
            <div className="mt-3 max-w-xs">
              <label className="text-xs font-semibold text-slate-700 mb-1.5 block">
                Marka <span className="font-normal text-slate-400">(listede yoksa yazın, boş = tüm markalar)</span>
              </label>
              <input
                type="text"
                placeholder="Örn: Rowenta"
                value={selectedBrand}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2 border-t border-slate-100">
            ...
            <div>
              <label className="text-xs font-semibold text-slate-700 mb-1.5 block">
                Arama kelimesi <span className="font-normal text-slate-400">(isteğe bağlı, Türkçe olabilir)</span>
              </label>
              <div className="relative">
                <Search className="w-4 h-4 text-slate-400 absolute left-3 top-3" />
                <input
                  type="text"
                  placeholder="Örn: yedek başlık, LatteGo, Ingenio"
                  value={customKeyword}
