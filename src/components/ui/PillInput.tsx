  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="relative flex items-center">
        ...
        <input
          className={`h-11 w-full rounded-full border border-border-subtle bg-surface-muted px-4 text-[14px] text-text-primary transition-all placeholder:text-text-muted focus:border-accent focus:bg-white focus:outline-none focus:ring-2 focus:ring-accent/25 ${
            prefixIcon ? 'pl-12' : ''
