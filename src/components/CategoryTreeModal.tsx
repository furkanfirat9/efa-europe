            ...
            <div className="flex items-center bg-slate-100 p-0.5 rounded-lg border border-slate-200 text-xs font-semibold">
              <button
                ...
                className={`px-2.5 py-1 rounded-md transition-all ${
                  language === 'TR' ? 'bg-white text-blue-600' : 'text-slate-600 hover:text-slate-900'
                }`}
              >
                TR
              </button>
              <button
                ...
                className={`px-2.5 py-1 rounded-md transition-all ${
                  language === 'RU' ? 'bg-white text-blue-600' : 'text-slate-600 hover:text-slate-900'
                }`}
              >
                RU
              </button>
        ...
        <div className="p-4 border-b border-slate-100 bg-slate-50/60">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-9 py-2.5 bg-white border border-slate-200 focus:border-blue-500 rounded-xl text-xs text-slate-900 placeholder:text-slate-400 focus:outline-hidden focus:ring-2 focus:ring-blue-500/20 transition-all font-medium"
              autoFocus
            />
            {searchQuery && (
              <button
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold transition-all flex items-center gap-1"
                      >
                ...
                <div className="flex-1 overflow-y-auto p-2 space-y-1">
                  {selectedSub?.children && selectedSub.children.length > 0 ? (
                    ...
                    >
                      ...
                      <span className="text-[10px] font-semibold px-2 py-0.5 rounded-sm bg-slate-100 text-slate-500 group-hover:bg-blue-100 group-hover:text-blue-800 transition-all">
                        Seç
                      </span>
                    </button>
                  ) : (
